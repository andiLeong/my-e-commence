    ...
    <div class="relative">
        ...
        <div class="relative bg-gray-100 lg:bg-transparent">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 lg:grid lg:grid-cols-2">
                <div class="max-w-2xl mx-auto py-24 lg:py-64 lg:max-w-none">Welcome
                    <div class="lg:pr-16">
                        ...
                        <div class="mt-6">
                            <a href="{{route('product.index')}}" class="inline-block bg-blue-600 border border-transparent py-3 px-8 rounded-md font-medium text-white hover:bg-blue-700">Shop Productivity</a>
                        </div>
                    </div>
                </div>
            </div>
